...
# Detector = state_event_generator.RectangularVoidGeometry(module_id=[1,2,3],lx = [10,10,10],ly = [10,10,10],z=[10,20,30], void_x_boundary=4, void_y_boundary=4)

state_event_gen = StateEventGenerator(Detector, events = 5, n_particles=[5,5,2,2,6])
